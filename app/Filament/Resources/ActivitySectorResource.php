...
use App\Filament\Resources\ActivitySectorResource\Pages;
...
class ActivitySectorResource extends Resource
{
    protected static ?string $model = ActivitySector::class;

    protected static ?string $navigationIcon = 'heroicon-m-rocket-launch';

    protected static ?string $navigationGroup = 'Activity sector';

    protected static ?string $navigationLabel = 'Activity Sectors';
    ...
    {
        return [
            'index' => Pages\ListActivitySectors::route('/'),
            'create' => Pages\CreateActivitySector::route('/create'),
            'edit' => Pages\EditActivitySector::route('/{record}/edit'),
        ];
    }
}
