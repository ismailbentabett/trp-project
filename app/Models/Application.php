...
class Application extends Model implements ReservableInterface
{
    use HasFactory, Reservable;

    protected $fillable = [
        'title', 'theme', 'main_title', 'main_content', 'main_listing', 'secondary_title', 'secondary_content', 'secondary_listing', 'extra_title', 'extra_content', 'extra_listing',
        ...
        'appointment_text_color', 'appointment_background_color', 'content', 'media_id', 'architecture_content', 'architecture_title', 'architecture_media_id',
    ];
    ...
    public function architecturemedias()
    {
        return $this->belongsToMany(\Awcodes\Curator\Models\Media::class, 'application_architecture_media', 'application_id', 'architecture_media_id');
    }
