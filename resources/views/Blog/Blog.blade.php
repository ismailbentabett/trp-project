                    ...
                    <article aria-labelledby="question-title-81614">
                        <div>
                            ...
                            href="{{ route('blog.post', $post->id) }}"
                             class="relative w-full my-2 cursor-pointer">
                            ...
                            <a
                            href="{{ route('blog.post', $post->id) }}"
                            id="question-title-81614" class="mt-4 text-base font-medium text-gray-900 break-all	cursor-pointer">{{$post->title}}</a>
                        </div>
