<template>
    <button
        type="button"
        class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-cerulean-500 focus:ring-offset-2"
    >
        <svg
        ...
        <span class="mt-2 block text-sm font-medium text-gray-900">Empty</span>
    </button>
</template>
