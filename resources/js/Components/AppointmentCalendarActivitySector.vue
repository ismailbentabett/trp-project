...
const props = defineProps({
    id: String, // or Number, based on the expected type of the id
})

const { id } = toRefs(props) // Destructure and get `id` as a reactive ref
...
const submitReservation = async () => {
    ...
    try {
        ...
        await axios.post(route('activitysector.reserve'), {
            activity_sector_id: id.value,
