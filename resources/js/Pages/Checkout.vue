<template>
    <AuthenticatedLayout title="Paiement" description="Paiement">
                    ...
                    <div class="mt-10 lg:mt-0">
                        ...
                        <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                            ...
                            <ul role="list" class="divide-y divide-gray-200">
                                <li v-for="item in cart.cart_items" :key="item.id" class="flex py-6 px-4 sm:px-6">
 ...
 -->
                      ...
                      <p class="mt-1 text-sm text-gray-500">{{ product.size }}</p> -->
                                        ...
                                        <div class="flex flex-1 items-end justify-between pt-2">
                                            ...
                                            <div class="ml-4">
                                                <label for="quantity" class="">Quantité : {{ item.quantity }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <dl class="space-y-6 border-t border-gray-200 py-6 px-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <dd class="text-sm font-medium text-gray-900">{{ cart.total_amount }}€</dd>
                                </div>

                                <div class="flex items-center justify-between border-t border-gray-200 pt-6">
                                    <dt class="text-base font-medium">Total</dt>
                                    <dd class="text-base font-medium text-gray-900">{{ cart.total_amount }}€</dd>
                                </div>
                            </dl>
