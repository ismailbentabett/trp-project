                    ...
                    <div class="mt-14 sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-3">
                            ...
                            <input
                                ...
                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cerulean-500 focus:border-cerulean-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-cerulean-500 dark:focus:border-cerulean-500"
                                placeholder="Quantity"
                                required
                            />
                        </div>
                        <!-- attachment -->
                        <div v-if="documents.length > 0" class="sm:col-span-2 my-5">
                ...
                <div class="mx-auto mt-24 max-w-2xl sm:mt-32 lg:max-w-none">
                    ...
                    <div class="lg:col-span-3 m-5">
                        ...
                        <EmptyState />
                            ...
                            <div
                                class="flex flex-col gap-y-10 sm:flex-row sm:gap-x-6 lg:flex-row lg:gap-x-8 lg:flex-wrap"
                            >
                                <AccessoryCard
                                    v-for="accessory in filteredData"
                                    :key="accessory.id"
                                    :accessory="accessory"
                                    :addToCartBool="false"
                ...
                <div class="mx-auto mt-24 max-w-2xl sm:mt-32 lg:max-w-none">
                    ...
                    <div class="">
                        <section v-if="props.similarProducts.length > 0" aria-labelledby="related-heading">
                            ...
                            >
                                <ProductCard
                                    v-for="product in props.similarProducts"
                                    :key="product.id"
                                    :product="product"
                                />
                            </div>
...
import { PaperClipIcon, StarIcon } from '@heroicons/vue/20/solid'
