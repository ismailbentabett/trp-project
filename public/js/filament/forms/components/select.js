        ...
        return (function () {
            ...
            var se = {
                    282: function (j, i, b) {
                        ...
                        i.addChoice = h
                        var d = function (c) {
                            return { type: v.ACTION_TYPES.FILTER_CHOICES, results: c }
                        }
                        i.filterChoices = d
                        var a = function (c) {
                            return c === void 0 && (c = !0), { type: v.ACTION_TYPES.ACTIVATE_CHOICES, active: c }
                        }
                        i.activateChoices = a
                        var r = function () {
                        ...
                        var v = b(883),
                            h = function (d) {
                                var a = d.value,
                                    ...
                                    c = d.active,
                                    l = d.disabled
                                return { type: v.ACTION_TYPES.ADD_GROUP, value: a, id: r, active: c, disabled: l }
                            }
                        i.addGroup = h
                    },
                    464: function (j, i, b) {
                        ...
                        i.addItem = h
                        var d = function (r, c) {
                            return { type: v.ACTION_TYPES.REMOVE_ITEM, id: r, choiceId: c }
                        }
                        i.removeItem = d
                        var a = function (r, c) {
                            return { type: v.ACTION_TYPES.HIGHLIGHT_ITEM, id: r, highlighted: c }
                        }
                        i.highlightItem = a
                    },
                    137: function (j, i, b) {
                        ...
                        i.clearAll = h
                        var d = function (r) {
                            return { type: v.ACTION_TYPES.RESET_TO, state: r }
                        }
                        i.resetTo = d
                        var a = function (r) {
                            return { type: v.ACTION_TYPES.SET_IS_LOADING, isLoading: r }
                        }
                        i.setIsLoading = a
                    },
                    373: function (j, i, b) {
                        var v =
                                ...
                                function (g, e, t) {
                                    if (t || arguments.length === 2)
                                        for (var n = 0, o = e.length, _; n < o; n++)
                                            (_ || !(n in e)) &&
                                                (_ || (_ = Array.prototype.slice.call(e, 0, n)), (_[n] = e[n]))
                        ...
                        var d = h(b(996)),
                            ...
                            N = (function () {
                                function g(e, t) {
                                    ...
                                    var o = (0, k.diff)(this.config, D.DEFAULT_CONFIG)
                                    o.length && console.warn('Unknown config option(s) passed', o.join(', '))
                                    var _ = typeof e == 'string' ? document.querySelector(e) : e
                                    if (!(_ instanceof HTMLInputElement || _ instanceof HTMLSelectElement))
                                        throw TypeError(
                                            'Expected one of the following types text|select-one|select-multiple',
                                        )
                                    if (
                                        ((this._isTextElement = _.type === y.TEXT_TYPE),
                                        (this._isSelectOneElement = _.type === y.SELECT_ONE_TYPE),
                                        (this._isSelectMultipleElement = _.type === y.SELECT_MULTIPLE_TYPE),
                                ...
                                return (
                                    ...
                                    (g.prototype.unhighlightItem = function (e) {
                                        ...
                                        var t = e.id,
                                            ...
                                            M = e.label,
                                            K = M === void 0 ? '' : M,
                                            f = o >= 0 ? this._store.getGroupById(o) : null
                                        return (
                                    ...
                                    (g.prototype.getValue = function (e) {
                                        e === void 0 && (e = !1)
                                        var t = this._store.activeItems.reduce(function (n, o) {
                                            var _ = e ? o.value : o
                                            return n.push(_), n
                                        }, [])
                                    ...
                                    (g.prototype.setChoiceByValue = function (e) {
                                        ...
                                        return (
                                            n.forEach(function (o) {
                                                return t._findAndSelectChoiceByValue(o)
                                            }),
                                            this
                                        )
                                    }),
                                    (g.prototype.setChoices = function (e, t, n, o) {
                                        var _ = this
                                        if (
                                            (e === void 0 && (e = []),
                                            t === void 0 && (t = 'value'),
                                        ...
                                        if ((o && this.clearChoices(), typeof e == 'function')) {
                                            var P = e(this)
                                    ...
                                    (g.prototype._renderChoices = function () {
                                        ...
                                        if (
                                            ...
                                            var P = o.filter(function (C) {
                                                return C.placeholder === !0 && C.groupId === -1
                                            })
                                            P.length >= 1 && (_ = this._createChoicesFragment(P, _)),
                                                (_ = this._createGroupsFragment(n, o, _))
                                        } else o.length >= 1 && (_ = this._createChoicesFragment(o, _))
                                        if (_.childNodes && _.childNodes.length > 0) {
                                            var M = this._store.activeItems,
                                                K = this._canAddItem(M, this.input.value)
                                            if (K.response) this.choiceList.append(_), this._highlightChoice()
                                            else {
                                        ...
                                        var _ = function (P) {
                                            return t.filter(function (M) {
                                                return o._isSelectOneElement
                                                    ? M.groupId === P.id
                                                    : M.groupId === P.id &&
                                                          (o.config.renderSelectedChoices === 'always' || !M.selected)
                                            })
                                        }
                                        return (
                                            ...
                                            e.forEach(function (P) {
                                                var M = _(P)
                                                if (M.length >= 1) {
                                                    var K = o._getTemplate('choiceGroup', P)
                                                    n.appendChild(K), o._createChoicesFragment(M, n, !0)
                                                }
                                            }),
                                            n
                                        )
                                    ...
                                    (g.prototype._createChoicesFragment = function (e, t, n) {
                                        ...
                                        var _ = this.config,
                                            ...
                                            u = function (z) {
                                                var ee = P === 'auto' ? o._isSelectOneElement || !z.selected : !0
                                                if (ee) {
                                                    var ae = o._getTemplate('choice', z, o.config.itemSelectText)
                                                    t.appendChild(ae)
                                                }
                                            },
                                            C = e
                                        ...
                                        var $ = C.length,
                                            W = this._isSelectOneElement ? v(v([], V, !0), U, !0) : U
                                        ...
                                        if (
                                            ...
                                            e.forEach(function (P) {
                                                P.id === parseInt(''.concat(_), 10) && !P.highlighted
                                                    ? o.highlightItem(P)
                                                    : !n && P.highlighted && o.unhighlightItem(P)
                                            }),
                                                this.input.focus()
                                        }
                                    }),
                                    (g.prototype._handleChoiceAction = function (e, t) {
                                        if (!(!e || !t)) {
                                            var n = t.dataset.id,
                                                o = n && this._store.getChoiceById(n)
                                            if (o) {
                                                var _ = e[0] && e[0].keyCode ? e[0].keyCode : void 0,
                                                    P = this.dropdown.isActive
                                                if (
                                                    ((o.keyCode = _),
                                                    this.passedElement.triggerEvent(y.EVENTS.choice, { choice: o }),
                                                    !o.selected && !o.disabled)
                                                ) {
                                                    var M = this._canAddItem(e, o.value)
                                                    M.response &&
                                                        (this._addItem({
                                                            value: o.value,
                                                            label: o.label,
                                    ...
                                    (g.prototype._handleSearch = function (e) {
                                        if (this.input.isFocussed) {
                                            ...
                                            if (e !== null && typeof e < 'u' && e.length >= o) {
                                    ...
                                    (g.prototype._onKeyDown = function (e) {
                                        ...
                                        switch (
                                            ...
                                            case u:
                                            case f:
                                                return this._onDeleteKey(e, n, o)
                                            default:
                                        }
                                    }),
                                    ...
                                    (g.prototype._onEnterKey = function (e, t, n) {
                                        var o = e.target,
                                            _ = y.KEY_CODES.ENTER_KEY,
                                            P = o && o.hasAttribute('data-button')
                                        ...
                                        if ((P && (this._handleButtonAction(t, o), e.preventDefault()), n)) {
                                            ...
                                            f && (t[0] && (t[0].keyCode = _), this._handleChoiceAction(t, f)),
                                                e.preventDefault()
                                    ...
                                    (g.prototype._onMouseDown = function (e) {
                                        ...
                                        if (t instanceof HTMLElement) {
                                            ...
                                            if (t !== this.input.element) {
                                                var _ = t.closest('[data-button],[data-item],[data-choice]')
                                    ...
                                    (g.prototype._onFocus = function (e) {
                                        var t,
                                            n = this,
                                            o = e.target,
                                            _ = o && this.containerOuter.element.contains(o)
                                        if (_) {
                                            var P =
                                                ((t = {}),
                                                (t[y.TEXT_TYPE] = function () {
                                                    o === n.input.element && n.containerOuter.addFocusState()
                                                }),
                                                (t[y.SELECT_ONE_TYPE] = function () {
                                                    n.containerOuter.addFocusState(),
                                                        o === n.input.element && n.showDropdown(!0)
                                                }),
                                            ...
                                            var P = this._store.activeItems,
                                                ...
                                                K =
                                                    ...
                                                    (t[y.SELECT_ONE_TYPE] = function () {
                                                        n.containerOuter.removeFocusState(),
                                                            (o === n.input.element ||
                                                                (o === n.containerOuter.element && !n._canSearch)) &&
                                                                n.hideDropdown(!0)
                                                    }),
                                                    (t[y.SELECT_MULTIPLE_TYPE] = function () {
                                                        o === n.input.element &&
                                    ...
                                    (g.prototype._highlightChoice = function (e) {
                                        ...
                                        if (n.length) {
                                            ...
                                            _.forEach(function (P) {
                                                ...
                                                o
                                                    ? (this._highlightPosition = n.indexOf(o))
                                                    : (n.length > this._highlightPosition
                                                          ? (o = n[this._highlightPosition])
                                                          : (o = n[n.length - 1]),
                                                      o || (o = n[0])),
                                                o.classList.add(this.config.classNames.highlightedState),
                                                o.setAttribute('aria-selected', 'true'),
                                                this.passedElement.triggerEvent(y.EVENTS.highlightChoice, { el: o }),
                                    ...
                                    (g.prototype._addGroup = function (e) {
                                        var t = this,
                                            ...
                                            u = o || Math.floor(new Date().valueOf() * Math.random()),
                                    ...
                                    (g.prototype._addPredefinedGroups = function (e) {
                                        ...
                                        n &&
                                            ...
                                            e.forEach(function (o) {
                                                return t._addGroup({ group: o, id: o.id || null })
                                            })
                                    }),
                                    (g.prototype._addPredefinedChoices = function (e) {
                                        var t = this
                                        this.config.shouldSort && e.sort(this.config.sorter)
                                        var n = e.some(function (_) {
                                                return _.selected
                                            }),
                                        ...
                                        e.forEach(function (_, P) {
                                            ...
                                            if (t._isSelectElement)
                                                if (_.choices) t._addGroup({ group: _, id: _.id || null })
                                                else {
                                                    var Y = t._isSelectOneElement && !n && P === o,
                                                        V = Y ? !0 : _.selected,
                                                        U = _.disabled
                                                    t._addChoice({
                                                        value: K,
                            ...
                            h = (function () {
                                ...
                                return (
                                    ...
                                    (d.prototype.triggerEvent = function (a, r) {
                                        ;(0, v.dispatchEvent)(this.element, a, r)
                                    }),
                                    d
                                )
                            })()
                        ...
                        ;(i.DEFAULT_CLASSNAMES = {
                            ...
                            (i.DEFAULT_CONFIG = {
                                ...
                                addItemText: function (h) {
                                    return 'Press Enter to add <b>"'.concat((0, v.sanitise)(h), '"</b>')
                                },
                    ...
                    187: function (j, i, b) {
                        var v =
                            ...
                            h =
                                ...
                                function (d, a) {
                                    for (var r in d)
                                        r !== 'default' && !Object.prototype.hasOwnProperty.call(a, r) && v(a, d, r)
                                }
                        Object.defineProperty(i, '__esModule', { value: !0 }),
                            h(b(18), i),
                            h(b(978), i),
                    ...
                    799: function (j, i) {
                        ...
                        var L = function (E, w) {
                            var N = E.value,
                                ...
                                n = w.label,
                                o = n === void 0 ? t : n
                            return e.localeCompare(o, [], { sensitivity: 'base', ignorePunctuation: !0, numeric: !0 })
                        }
                        i.sortByAlpha = L
                        var y = function (E, w) {
                            var N = E.score,
                    ...
                    502: function (j, i) {
                        Object.defineProperty(i, '__esModule', { value: !0 }),
                            ...
                            (i.defaultState = !1)
                        var b = function (v, h) {
                            switch ((v === void 0 && (v = i.defaultState), h === void 0 && (h = {}), h.type)) {
                                case 'SET_IS_LOADING':
                                    return h.isLoading
                                default:
                                    return v
                    ...
                    686: function (j, i) {
                        Object.defineProperty(i, '__esModule', { value: !0 })
                        var b = {
                            containerOuter: function (v, h, d, a, r, c, l) {
                            ...
                            item: function (v, h, d) {
                                ...
                                if (
                                    ...
                                    o.setAttribute('aria-label', ''.concat(n, ": '").concat(Z, "'")),
                                        (o.dataset.button = ''),
                                        t.appendChild(o)
                                }
                                return t
                    ...
                    221: function (j, i, b) {
                        ...
                        function _(p, s) {
                            ...
                            return I(p, r(s) ? s.split('.') : s, 0), S ? m : m[0]
                        }
                        var u = {
                            ...{
                                isCaseSensitive: !1,
                                ...
                                shouldSort: !0,
                                sortFn: (p, s) =>
                                    p.score === s.score ? (p.idx < s.idx ? -1 : 1) : p.score < s.score ? -1 : 1,
                            },
                        ...
                        class V {
                            constructor({ getFn: s = u.getFn, fieldNormWeight: m = u.fieldNormWeight } = {}) {
                                ;(this.norm = Y(m, 3)), (this.getFn = s), (this.isCreated = !1), this.setIndexRecords()
                            }
                            setSources(s = []) {
                                this.docs = s
                            }
                            ...
                            add(s) {
                                let m = this.size()
                                r(s) ? this._addString(s, m) : this._addObject(s, m)
                            }
                            removeAt(s) {
                                this.records.splice(s, 1)
                                for (let m = s, S = this.size(); m < S; m += 1) this.records[m].i -= 1
                            }
                            getValueForItemAtKeyId(s, m) {
                                return s[this._keysMap[m]]
                            }
                            size() {
                            ...
                            _addString(s, m) {
                                if (!y(s) || D(s)) return
                                let S = { v: s, i: m, n: this.norm.get(s) }
                                this.records.push(S)
                            }
                            _addObject(s, m) {
                                let S = { i: m, $: {} }
                        ...
                        function U(p, s, { getFn: m = u.getFn, fieldNormWeight: S = u.fieldNormWeight } = {}) {
                            let I = new V({ getFn: m, fieldNormWeight: S })
                            return I.setKeys(p.map(t)), I.setSources(s), I.create(), I
                        }
                        function $(p, { getFn: s = u.getFn, fieldNormWeight: m = u.fieldNormWeight } = {}) {
                            let { keys: S, records: I } = p,
                                T = new V({ getFn: s, fieldNormWeight: m })
                        ...
                        function J(p = [], s = u.minMatchCharLength) {
                            let m = [],
                                S = -1,
                                I = -1,
                                T = 0
                            for (let A = p.length; T < A; T += 1) {
                                ...
                                R && S === -1
                                    ? (S = T)
                                    : !R && S !== -1 && ((I = T - 1), I - S + 1 >= s && m.push([S, I]), (S = -1))
                            }
                            return p[T - 1] && T - S >= s && m.push([S, T - 1]), m
                        }
                        let z = 32
                        function ee(
                            p,
                        ...
                        class ce {
                            ...
                            searchIn(s) {
                                ...
                                if ((m || (s = s.toLowerCase()), this.pattern === s)) {
                        ...
                        class pe extends le {
                            ...
                            search(s) {
                                let m = s.startsWith(this.pattern)
                                return { isMatch: m, score: m ? 0 : 1, indices: [0, this.pattern.length - 1] }
                            }
                        }
                        class oe extends le {
                            ...
                            search(s) {
                                let m = !s.startsWith(this.pattern)
                                return { isMatch: m, score: m ? 0 : 1, indices: [0, s.length - 1] }
                            }
                        }
                        class Te extends le {
                            constructor(s) {
                        ...
                        class Be extends le {
                            ...
                            search(s) {
                                ...
                                for (; (S = s.indexOf(this.pattern, m)) > -1; ) (m = S + T), I.push([S, m - 1])
                                let A = !!I.length
                        ...
                        class qe {
                            constructor(
                                ...
                                ;(this.query = null),
                                    ...
                                    (this.pattern = m ? s : s.toLowerCase()),
                                    (this.query = Qe(this.pattern, this.options))
                            }
                            static condition(s, m) {
                        ...
                        function Ne(p, s) {
                            for (let m = 0, S = De.length; m < S; m += 1) {
                                let I = De[m]
                                if (I.condition(p, s)) return new I(p, s)
                            }
                            return new ce(p, s)
                        }
                        let Ce = { AND: '$and', OR: '$or' },
                            ...
                            tt = (p) => !!p[je.PATH],
                            it = (p) => !v(p) && O(p) && !Re(p),
                            ke = (p) => ({ [Ce.AND]: Object.keys(p).map((s) => ({ [s]: p[s] })) })
                        function xe(p, s, { auto: m = !0 } = {}) {
                            let S = (I) => {
                                let T = Object.keys(I),
                                    A = tt(I)
                                ...
                                if (it(I)) {
                                    ...
                                    let B = { keyId: o(F), pattern: H }
                                    return m && (B.searcher = Ne(H, s)), B
                                }
                        ...
                        function nt(p, { ignoreFieldNorm: s = u.ignoreFieldNorm }) {
                            p.forEach((m) => {
                                let S = 1
                                m.matches.forEach(({ key: I, norm: T, score: A }) => {
                                    let R = I ? I.weight : null
                                    S *= Math.pow(A === 0 && R ? Number.EPSILON : A, (R || 1) * (s ? 1 : T))
                                }),
                                    (m.score = S)
                            })
                        }
                        ...
                        class Se {
                            ...
                            setCollection(s, m) {
                                if (((this._docs = s), m && !(m instanceof V))) throw new Error(Z)
                                this._myIndex =
                                    m ||
                            ...
                            remove(s = () => !1) {
                                ...
                                for (let S = 0, I = this._docs.length; S < I; S += 1) {
                                    let T = this._docs[S]
                                    s(T, S) && (this.removeAt(S), (S -= 1), (I -= 1), m.push(T))
                                }
                                return m
                            }
                            removeAt(s) {
                            ...
                            _findMatches({ key: s, value: m, searcher: S }) {
                                if (!y(m)) return []
                                let I = []
                                if (v(m))
                                    m.forEach(({ v: T, i: A, n: R }) => {
                                        ...
                                        F && I.push({ score: H, key: s, value: T, idx: A, norm: R, indices: B })
                                    })
                                else {
                                    let { v: T, n: A } = m,
                                        { isMatch: R, score: F, indices: H } = S.searchIn(T)
                                    R && I.push({ score: F, key: s, value: T, norm: A, indices: H })
                                }
                                return I
                            }
                        }
                    ...
                    791: function (j, i, b) {
                        ...
                        function _(f, u) {
                            if (typeof f == 'function') return o(f, u)
                            if (typeof f != 'object' || f === null) throw new Error(l(16))
                            var C = {}
                            for (var Y in f) {
                                var V = f[Y]
                                typeof V == 'function' && (C[Y] = o(V, u))
                            }
                            return C
                        }
                        function P() {
    ...
    return {
        ...
        getExistingOptions: async function ({ search: e, withInitialOptions: t }) {
            ...
            return (
                ...
                n.map((o) =>
                    Array.isArray(this.state) && this.state.includes(o.value) ? ((_) => ((_.selected = !0), _))(o) : o,
                )
            )
        },
        ...
        formatState: function (e) {
            return v ? (e ?? []).map((t) => t?.toString()) : e?.toString()
        },
        getMissingOptions: async function (e) {
            let t = this.formatState(this.state)
            if ([null, void 0, '', [], {}].includes(t)) return {}
            let n = new Set(e.length ? e.map((o) => o.value) : [])
            return v
                ? t.every((o) => n.has(o))
                    ? {}
                    : (await me()).filter((o) => !n.has(o.value)).map((o) => ((o.selected = !0), o))
                : n.has(t)
                  ? n
