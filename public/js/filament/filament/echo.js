;(() => {
    ...
    var xi = (l, h, a, c) => {
        if ((h && typeof h == 'object') || typeof h == 'function')
            for (let s of Si(h))
                !Ti.call(l, s) && s !== a && he(l, s, { get: () => h[s], enumerable: !(c = ki(h, s)) || c.enumerable })
        return l
    }
    var Oi = (l, h, a) => (
        (a = l != null ? wi(Ci(l)) : {}),
                ...
                function (l, h, a) {
                    ...
                    function Ie() {
                        for (var e = ['Pusher'], t = 0; t < arguments.length; t++)
                            typeof arguments[t] == 'string' ? e.push(arguments[t]) : e.push(at(arguments[t]))
                        return e.join(' : ')
                    }
                    function qt(e, t) {
                            ...
                            return (
                                (e.prototype.send = function (t, n) {
                                    this.timeline.isEmpty() ||
                                        this.timeline.send(b.TimelineTransport.getAgent(this, t), n)
                                }),
                                e
                            )
                        })(),
                                    ...
                                    var p = j.now(),
                                        _ = o.pop().connect(t, function g(k, L) {
                                            k
                                                ...
                                                : (or(r, L.transport.name, j.now() - p), n(null, L))
                                        })
                                    return {
                                        abort: function () {
                                            _.abort()
                    ...
                    var hr = function (e, t, n) {
                            ...
                            return (
                                t.useTLS
                                    ...
                                    : (xt = new wt([ie, new ut(vi, { delay: 2e3 }), new ut(Pt, { delay: 5e3 })])),
                        ...
                        gr = (function (e) {
                            ...
                            return (
                                ...
                                (t.prototype.close = function () {
                                    this.unloader && (b.removeUnloadListener(this.unloader), (this.unloader = null)),
                        ...
                        br = (function () {
                            ...
                            return (
                                ...
                                (e.prototype.sendRaw = function (t) {
                                    if (this.readyState === $.OPEN)
                                        try {
                                            return (
                                                b
                                                    .createSocketRequest('POST', Kt(kr(this.location, this.session)))
                                                    .start(t),
                                                !0
                                            )
                                        } catch {
                                ...
                                (e.prototype.onOpen = function (t) {
                                    this.readyState === $.CONNECTING
                                        ? (t && t.hostname && (this.location.base = Sr(this.location.base, t.hostname)),
            ...
            return (
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels[s] || (this.channels[s] = new pt(this.pusher, s, this.options)),
                                this.channels[s]
                            )
                        },
                    },
                        ...
                        value: function (s) {
                            return (
                                this.channels['private-' + s] ||
                                    (this.channels['private-' + s] = new Ri(this.pusher, 'private-' + s, this.options)),
                                this.channels['private-' + s]
                            )
                        },
                    },
            ...
            return (
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels[s] || (this.channels[s] = new de(this.socket, s, this.options)),
                                this.channels[s]
                            )
                        },
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels['private-' + s] ||
                                    (this.channels['private-' + s] = new ve(this.socket, 'private-' + s, this.options)),
                                this.channels['private-' + s]
                            )
                        },
                    },
