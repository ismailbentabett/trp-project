;(() => {
            ...
            ;(function (p, d, P) {
                ...
                function v(e) {
                    ...
                    function j(r, s, l, i, u, m) {
                        ...
                        for (k == 'keyup' && C(r) && (s = [r]), f = 0; f < t._callbacks[r].length; ++f)
                            if (
                                ((_ = t._callbacks[r][f]),
                                !(!i && _.seq && a[_.seq] != _.level) &&
                                    k == _.action &&
                                    ((k == 'keypress' && !l.metaKey && !l.ctrlKey) || $(s, _.modifiers)))
                            ) {
                                var Q = !i && _.combo == u,
                    ...
                    function x(r, s, l, i) {
                        t.stopCallback(s, s.target || s.srcElement, l, i) || (r(s, l) === !1 && (V(s), H(s)))
                    }
    ...
    document.addEventListener('alpine:init', () => {
        ...
        window.Alpine.store(
            'theme',
            o === 'dark' || (o === 'system' && window.matchMedia('(prefers-color-scheme: dark)').matches)
                ? 'dark'
                : 'light',
        ),
