...
var Ve = (i) => i === 0 || i === 1,
    ...
    Ht = {
        ...
        easeInOutElastic(i) {
            return Ve(i) ? i : i < 0.5 ? 0.5 * As(i * 2, 0.1125, 0.45) : 0.5 + 0.5 * Ts(i * 2 - 1, 0.1125, 0.45)
        },
        easeInBack(i) {
...
function Fs(i) {
    ...
    return (
        Array.isArray(i)
            ? i.length >= 3 && ((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = vt(i[3])))
...
function rn(i, t, e, s) {
    ...
    for (l = 0; l < r; l++)
        ...
        else if (I(d)) for (c = 0, h = d.length; c < h; c++) (u = d[c]), u != null && !I(u) && (a = me(i, n, o, a, u))
    i.restore()
    let f = o.length / 2
    if (f > e.length) {
...
var ma = (i, t) => (i ? i + Ke(t) : t),
    qi = (i, t) => D(t) && i !== 'adapters' && (Object.getPrototypeOf(t) === null || t.constructor === Object)
function dn(i, t, e) {
...
function On(i, t, e, s) {
    let n = i.iScale,
        ...
        d,
        u
    for (c = e, h = e + s; c < h; ++c) (u = t[c]), (d = {}), (d[n.axis] = r || n.parse(a[c], c)), l.push(po(u, d, o, c))
    return l
}
function rs(i) {
...
var _t = class extends it {
        ...
        calculateLabelRotation() {
            ...
            ;(r = t.offset ? this.maxWidth / s : f / (s - 1)),
                d + 6 > r &&
                    ...
                    (l = this.maxHeight - Me(t.grid) - e.padding - En(t.title, this.chart.options.font)),
                    (c = Math.sqrt(d * d + u * u)),
                    (a = qe(
                        Math.min(
        ...
        _computeLabelItems(t) {
            ...
            for (b = 0, _ = r.length; b < _; ++b) {
                ...
                if (P.showLabelBackdrop) {
                    ...
                    Be = { left: Mi, top: vi, width: yi + Wt.width, height: ue + Wt.height, color: P.backdropColor }
                }
                m.push({
                    rotation: p,
                    label: y,
        ...
        drawBorder() {
            ...
            let a = s.setContext(this.getContext(0)).lineWidth,
                ...
                d
            this.isHorizontal()
                ? ((l = wt(t, this.left, o) - o / 2), (c = wt(t, this.right, a) + a / 2), (h = d = r))
                : ((h = wt(t, this.top, o) - o / 2), (d = wt(t, this.bottom, a) + a / 2), (l = c = r)),
                e.save(),
    ...
    te = class {
        ...
        unregister(t) {
            let e = this.items,
                s = t.id,
                n = this.scope
            s in e && delete e[s], n && s in O[n] && (delete O[n][s], this.override && delete Mt[s])
        }
    }
function Ar(i, t, e) {
...
function ko(i) {
    return (
        Ji() && typeof i == 'string' ? (i = document.getElementById(i)) : i && i.length && (i = i[0]),
...
var ce = class extends it {
    ...
    draw(t) {
        ...
        t.save(),
            (a.w !== o.w || a.h !== o.h) &&
                (t.beginPath(), r(t, us(a, e, o)), t.clip(), r(t, us(o, -e, a)), (t.fillStyle = s), t.fill('evenodd')),
            t.beginPath(),
            r(t, us(o, e)),
            (t.fillStyle = n),
            t.fill(),
...
ce.id = 'bar'
ce.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, inflateAmount: 'auto', pointStyle: void 0 }
ce.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }
var Wl = Object.freeze({ __proto__: null, ArcElement: re, LineElement: dt, PointElement: le, BarElement: ce })
...
function fs(i, t, e) {
    ...
    s &&
        n.points.length &&
        (xe(i, e), lc(i, { line: n, target: s, above: h, below: d, area: e, scale: o, axis: a }), ye(i))
}
function lc(i, t) {
    ...
    mi = class extends it {
        ...
        _draw() {
            ...
            let { boxWidth: p, boxHeight: m, itemHeight: b } = to(a, u),
                ...
                v = function (w, S, k) {
                    kt(n, k.text, w, S + b / 2, c, { strikethrough: k.hidden, textAlign: l.textAlign(k.textAlign) })
                },
                y = this.isHorizontal(),
...
function Oc(i, t) {
    ...
    ;(k = Math.ceil(m / x) - Math.floor(p / x)),
        ...
        b && _ && o && Us((r - a) / o, x / 1e3)
            ...
            : v
              ...
              : ((k = (S - w) / x), Kt(k, Math.round(k), x / 1e3) ? (k = Math.round(k)) : (k = Math.ceil(k)))
    ...
    for (
        b &&
        (u && w !== a
            ? (e.push({ value: a }), w < a && R++, Kt(Math.round((w + R * x) * M) / M, a, ao(a, y, i)) && R++)
            : w < a && R++);
        R < k;
        ++R
    )
...
function Bc(i, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        kt(e, i._pointLabels[n], r, l + a.lineHeight / 2, a, { color: o.color, textAlign: c, textBaseline: 'middle' })
    }
}
function Lo(i, t, e, s) {
    let { ctx: n } = i
...
function co(i, t) {
    ...
    return (
        ...
        a === null
            ? null
            : (n && (a = n === 'week' && (Rt(o) || o === !0) ? e.startOf(a, 'isoWeek', o) : e.startOf(a, n)), +a)
    )
}
function ho(i, t, e, s) {
    let n = Z.length
...
function Xc({ dataChecksum: i, labels: t, values: e }) {
    return {
        ...
        initChart: function () {
            return (
                (ze.defaults.backgroundColor = getComputedStyle(this.$refs.backgroundColorElement).color),
                (ze.defaults.borderColor = getComputedStyle(this.$refs.borderColorElement).color),
                new ze(this.$refs.canvas, {
                    type: 'line',
                    data: { labels: t, datasets: [{ data: e, borderWidth: 2, fill: 'start', tension: 0.5 }] },
                    options: {
